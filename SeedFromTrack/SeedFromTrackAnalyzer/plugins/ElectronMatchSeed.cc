#ifndef ELECTRONMATCHSEEDNEW_H
#define ELECTRONMATCHSEEDNEW_H
...
class ElectronMatchSeedNew : public edm::one::EDAnalyzer<edm::one::SharedResources, edm::one::WatchRuns, edm::one::WatchLuminosityBlocks> {
    public:
		explicit ElectronMatchSeedNew(const edm::ParameterSet& iConfig);
		~ElectronMatchSeedNew();
...
ElectronMatchSeedNew::ElectronMatchSeedNew(const edm::ParameterSet& iConfig): 
      ...
      electronCollection(consumes<reco::ElectronCollection>(iConfig.getParameter<edm::InputTag>("electrons"))),
...
ElectronMatchSeedNew::~ElectronMatchSeedNew() {}
...
{   
	...
	const TrackerTopology* httopo = &iSetup.getData(topoToken_);
...
void ElectronMatchSeedNew::beginLuminosityBlock(edm::LuminosityBlock const& iLumi, edm::EventSetup const&) {}
void ElectronMatchSeedNew::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&) {}
